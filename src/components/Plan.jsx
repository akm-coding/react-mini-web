    ...
    <div className="max-w-[1400px] m-auto py-16 px-4 grid lg:grid-cols-2 gap-4">
      ...
      <div className=" flex flex-col h-full justify-center">
        ...
        <p className=" pb-6">
          ...
          perferendis at dolor architecto quod placeat similique doloremque,
          officiis quaerat voluptates magni aut. Beatae a nesciunt suscipit
          molestiae, doloremque eaque alias.
        </p>
        <div>
